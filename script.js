...
const DRINKS = {
  "sunset":            { cat: "FOCUS ／ SIGNATURE", flavor: "sunset",    name: "サンセットティーソーダ", sub: "with アップルマンゴーソルベ", price: "¥800", img: "drink-sunset.png",
    desc: "カクテル「テキーラサンライズ」から着想した看板フロート。アールグレイ オレンジペコとオレンジのベースに、真夏の夕日に見立てた完熟アップルマンゴーのソルベを浮かべ、最後にグレナデンを沈めて夕陽のグラデーションを描きます。アールグレイの華やぎとオレンジの甘みが層をなし、後半はドライフルーツが溶け出してトロピカルな表情に変わります。" },
  "herbal":            { cat: "FOCUS ／ SIGNATURE", flavor: "herbal",    name: "ハーバルティーソーダ", sub: "with ハニーレモンソルベ", price: "¥800", img: "drink-herbal.png",
    desc: "機能性レモン「OFF LEMON」のスカッシュに、真夏の昼の太陽をイメージした福岡県産はちみつレモンのソルベを浮かべた昼の看板。仕上げにシトラスカモミールをそっと浮かせ、澄んだグラデーションを描きます。レモンの酸味にカモミールの華やかさが重なり、後半ははちみつ×シトラスの表情へ。ノンカフェインで、暑い日にごくごくひと息つきたい時に。" },
  "earlgrey-peach":    { cat: "TEA SODA", flavor: "rose", name: "アールグレイ ピーチ ソーダ", sub: "", price: "¥700", img: "",
    desc: "アールグレイ オレンジペコの芳醇な香りに、ホワイトピーチのジューシーな甘みを重ねた分かりやすい人気者。香りとピーチの、迷いのない美味しさで「とりあえずの一杯」にも自信を持っておすすめできます。" },
